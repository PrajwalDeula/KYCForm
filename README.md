To run the project, the first thing that you need to do is open the Django project. Then, you use command "cd office" in your terminal and type "python manage.py runserver". By doing this, the application runs. The KYCForm is in its initial stage, meaning there are several types of issues. 
